      ...
      <DrawerContent className="max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="px-4 overflow-y-auto">
          <div className="space-y-4 pb-6">
            ...
            {/* Delivery Time & Revisions moved up/grouped */}
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      setFormData(prev => ({
                        ...prev,
                        allowRevisions: !!checked,
                        revisions: checked ? 1 : 0
                      }));
                    }}
                  />
                </div>
                ...
                />
                {formData.allowRevisions && <p className="text-xs text-muted-foreground w-full">Maksimal 10x</p>}
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.pricingType || "FIXED"} onValueChange={(value) => handleChange("pricingType", value as any)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="CUSTOM">⚙️ Custom (dijelaskan di informasi tambahan)</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                <Label htmlFor="whatsIncluded">Yang Didapat Customer (Detail)</Label>
                <Textarea
                  id="whatsIncluded"
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {formData.images.map((url, index) => (
                  <div
                    key={index}
                    className="relative group w-full h-32 rounded-md overflow-hidden bg-muted"
                  >
                    <Image
                      src={url}
                      alt={`Preview ${index + 1}`}
